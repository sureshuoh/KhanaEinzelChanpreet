...
public class TicketPrintProperties {
	...
	private boolean showGuestAdditionalInfo;
	...
	public TicketPrintProperties(String receiptTypeName, boolean showHeader, boolean showFooter, 
	    boolean showSubtotal,boolean showGuestAddInfo) {
		super();
		this.receiptTypeName = receiptTypeName;
		this.showHeader = showHeader;
		this.showFooter = showFooter;
		this.showSubtotal = showSubtotal;
		this.showGuestAdditionalInfo = showGuestAddInfo;
	}
	...
	public boolean isShowGuestAdditionalInfo(){
		return showGuestAdditionalInfo;
	}
	public void setGuestAdditionalInfo(boolean addInfo){
		this.showGuestAdditionalInfo = addInfo;
	}
