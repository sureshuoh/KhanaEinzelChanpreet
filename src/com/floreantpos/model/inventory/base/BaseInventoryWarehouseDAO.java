 ...
 */
public abstract class BaseInventoryWarehouseDAO extends com.floreantpos.model.inventory.dao._RootDAO {
...
/* Generic methods */
	 ...
	 * Return all objects related to the implementation of this DAO with no filter.
	 */
	public java.util.List<com.floreantpos.model.inventory.InventoryWarehouse> findAll (Order defaultOrder) {
	 ...
	 * @param s the Session
	 */
	public java.util.List<com.floreantpos.model.inventory.InventoryWarehouse> findAll (Session s, Order defaultOrder) {
