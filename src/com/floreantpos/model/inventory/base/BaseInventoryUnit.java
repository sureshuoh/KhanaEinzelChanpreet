...
public abstract class BaseInventoryUnit  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.floreantpos.model.inventory.InventoryUnit)) return false;
		else {
			com.floreantpos.model.inventory.InventoryUnit inventoryUnit = (com.floreantpos.model.inventory.InventoryUnit) obj;
