 ...
 */
public abstract class BaseInventoryTransactionTypeDAO extends com.floreantpos.model.inventory.dao._RootDAO {
	...
	public static InventoryTransactionTypeDAO getInstance () {
		if (null == instance) instance = new InventoryTransactionTypeDAO();
		return instance;
	}
...
/* Generic methods */
	 ...
	 * Return all objects related to the implementation of this DAO with no filter.
	 */
	public java.util.List<com.floreantpos.model.inventory.InventoryTransactionType> findAll (Order defaultOrder) {
	 ...
	 * @param s the Session
	 */
	public java.util.List<com.floreantpos.model.inventory.InventoryTransactionType> findAll (Session s, Order defaultOrder) {
