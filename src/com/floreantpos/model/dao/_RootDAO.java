...
public abstract class _RootDAO extends com.floreantpos.model.dao._BaseRootDAO {
	...
	public static Configuration getNewConfiguration(String configFileName) {
		...
		configuration = configuration.addClass(PropertyData.class);
		configuration = configuration.addClass(Gutschein.class);
		...
		configuration = configuration.addClass(CallList.class);
		configuration = configuration.addClass(MenuItemPrice.class);
		configuration = configuration.addClass(Salesreportdb.class);
		configuration = configuration.addClass(Street.class);
		configuration = configuration.addClass(Gebiet.class);
		configuration = configuration.addClass(Reservation.class);
		configuration = configuration.addClass(Cashbook.class);
		configuration = configuration.addClass(MenuUsage.class);
		configuration = configuration.addClass(CashBookData.class);
		configuration = configuration.addClass(TSEReceiptData.class);
		configuration = configuration.addClass(Zvt.class);
		...
		configuration = configuration.setProperty("hibernate.c3p0.min_size", "0");
		configuration = configuration.setProperty("hibernate.c3p0.max_size", "5");
