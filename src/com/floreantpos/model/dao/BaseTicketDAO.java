...
/* Generic methods */
	...
	public void delete(java.lang.Integer id)
		...
		try {
			List<KitchenTicket> kitcheTickets = KitchenTicketDAO.getInstance().findByTicketId(id);
			...
			for(KitchenTicket kTicket:kitcheTickets) {
				KitchenTicketDAO.getInstance().delete(kTicket.getId());		
			}
		}catch(Exception ex) {
			ex.printStackTrace();
			
			System.out.println("ticket delete exception in local function : "+ex.getMessage());
