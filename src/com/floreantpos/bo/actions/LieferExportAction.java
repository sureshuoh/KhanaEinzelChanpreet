...
public class LieferExportAction extends AbstractAction{
	public LieferExportAction() {
		super("Export Liefergebiet");
	}
	public LieferExportAction(String name) {
		super(name);
		init();
	}
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			boolean success = DeliveryCostDB.exportLiefer(file);
	...
	public static JFileChooser getFileChooser() {
		...
		fileChooser.setSelectedFile(new File("Khana-Liefergebiet-Daten.xml"));
