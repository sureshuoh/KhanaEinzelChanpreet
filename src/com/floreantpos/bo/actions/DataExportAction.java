...
public class DataExportAction extends AbstractAction {
  public DataExportAction() {
    super("Produkt Export");
  }

  public DataExportAction(String name) {
    super(name);
    init();
  }
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    try {
      ...
      if (file.exists()) {
        option = JOptionPane.showConfirmDialog(BackOfficeWindow.getInstance(), "Overwrite file " + file.getName() + "?",
      ...
      elements.setMenuItemPrices(MenuItemPriceDAO.getInstance().findAll(session));
      ...
      POSMessageDialog.showMessage(BackOfficeWindow.getInstance(),
          "Saved! - Category = " + elements.getMenuCategories().size() + ", Groups -" + elements.getMenuGroups().size()
              + ", Items - " + elements.getMenuItems().size());
  ...
  public static JFileChooser getFileChooser() {
    ...
    fileChooser.setSelectedFile(new File("Khana-menu-items.xml"));
    FileNameExtensionFilter fnef = new FileNameExtensionFilter(".xml","xls", "xlsx", "xlsm","Files");
