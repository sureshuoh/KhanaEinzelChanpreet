...
public class DatabaseConfigurationView extends ConfigurationView implements ActionListener {
	...
	protected void initUI() {
		...
		cbServer= new JCheckBox("Set Server");
		cbServer.setBackground(new Color(209,222,235));
		buttonPanel.add(cbServer);
		cbServer.setSelected(TerminalConfig.isKhanaServer());
		cbServer.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				TerminalConfig.setKhanaServer(cbServer.isSelected());				
			}
		});
