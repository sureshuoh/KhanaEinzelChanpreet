...
import com.floreantpos.add.service.ImagePanel;
...
public class TablePlanDeisgn extends POSDialog implements MouseListener{
	...
	public TablePlanDeisgn() throws IOException
	{
		super();
	...
	public void initComponents() throws IOException
	{
		...
		Image image;
		image = ImageIO.read(new File("resources/images/floorPlan.png"));
		...
		tableList = ShopTableDAO.getInstance().getByFloor(1);
