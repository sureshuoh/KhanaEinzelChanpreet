...
public class MenuModifierForm extends BeanEditor {
	...
	public String getDisplayText() {
    	...
    	if(modifier.getId() == null) {
    		if(StringUtils.isNotEmpty(POSConstants.Neue_Menuezutat))
    		   return	POSConstants.Neue_Menuezutat;
    		else
    		   return "Neue Menuezutat";
    	}
    	if(StringUtils.isNotEmpty(POSConstants.Menuezutat_bearbeiten))
 		   return	POSConstants.Menuezutat_bearbeiten;
    	else
    	   return "Menuezutat bearbeiten";
    }
}
