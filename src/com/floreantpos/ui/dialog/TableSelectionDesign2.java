...
public class TableSelectionDesign2 extends POSDialog{
	ImagePanel panel;
	JPanel buttonPanel;
	Ticket ticket;
	...
	public TableSelectionDesign2(boolean change) throws IOException
	{
		initComponents();
		this.change = change;
	}
	...
	public void initComponents() throws IOException
	{
		...
		Image image = ImageIO.read(new File("resources/images/floorPlan1.png"));
		...
		List<ShopTable> tableList = ShopTableDAO.getInstance().getByFloor(2);
			if(tableList != null)
			{
	...
	private boolean addTable(int tableNr) {
		...
		if(change)
		{
			...
			{
				POSMessageDialog.showError(this, "Tisch wechseln zum 99/98 ist nicht moeglich");
				return false;
			}
