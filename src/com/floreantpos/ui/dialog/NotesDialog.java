...
public class NotesDialog extends POSDialog {
    ...
    private void initComponents() {
        ...
        noteView.setBackground(new Color(209,222,235));
        getContentPane().setBackground(new Color(209,222,235));
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        getContentPane().add(titlePanel, java.awt.BorderLayout.NORTH);

        posButton1.setText(com.floreantpos.POSConstants.FINISH);
        posButton1.setBackground(new Color(102,255,102));
        ...
        posButton2.setBackground(new Color(255,153,153));
	...
	public void setNote(String notes) {
		noteView.getNote().setText(notes);
	}
